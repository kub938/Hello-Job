...
import Interview from "@/pages/Interview/pages/InterviewLayoutPage";
import StandardLayout from "@/components/layouts/StandardLayout";
import InterviewSelect from "@/pages/Interview/pages/TypeSelectPage";
...
import CheckPage from "@/pages/Interview/pages/PreparePage";
