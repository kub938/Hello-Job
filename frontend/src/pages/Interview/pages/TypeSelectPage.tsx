    ...
    <div className="my-5 flex flex-col items-center ">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <div className="rounded-lg border flex flex-col justify-center w-130 h-110 border-gray-200 bg-white p-8 shadow-sm transition-all hover:shadow-md">
          ...
          <h3 className="mb-4 text-center text-xl font-bold">단일 문항 연습</h3>
          ...
          <Link
            ...
            className="block w-full rounded-md border border-primary bg-white py-3 text-center font-medium text-primary transition-colors hover:bg-secondary-light"
          >
            단일 문항 시작하기
          </Link>
        </div>
        ...
        <div className="rounded-lg border flex flex-col justify-center w-130 h-110 border-gray-200 bg-white p-8 shadow-sm transition-all hover:shadow-md">
          ...
          <h3 className="mb-4 text-center text-xl font-bold">완전 모의면접</h3>
          <p className="mb-6 text-center text-gray-600">
      ...
      <div className="mt-12 rounded-lg bg-secondary-light p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="mb-2 font-medium">처음 면접 연습을 시작하시나요?</h4>
